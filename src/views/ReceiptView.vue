...
<template>
  <header>
    ...
    <ShareText :value="longURL" :display="shortURL" title="Cheti" text="Check out my receipt" />
  </Transition>
  </header>
  <main>
...
export default {
  ...
  computed: {
    shortURL() {
      return `cheti.vercel.app/receipt/${this.id}`;
    },
    longURL() {
      return `https://cheti.vercel.app/receipt/${this.id}`;
    },
    merchant() {
